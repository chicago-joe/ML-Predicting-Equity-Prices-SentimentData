...
def SPY():
    ...
    path = 'C:\\Users\\jloss\\PyCharmProjects\\ML-Predicting-Equity-Prices-SentimentData\\Source Code\\SMA Data Upload\\SPY Data\\'

    spyprice=pd.read_csv(path + "SPY Price Data.csv")
...
def readdata():
    ...
    path = 'C:\\Users\\jloss\\PyCharmProjects\\ML-Predicting-Equity-Prices-SentimentData\\Source Code\\SMA Data Upload\\Activity Feed Data\\'
