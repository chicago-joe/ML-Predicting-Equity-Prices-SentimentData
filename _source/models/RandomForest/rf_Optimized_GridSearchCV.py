...
y_train = pd.read_csv("../../../_2019/Source Code/week 9/train_y.txt", sep = ',', header = None)
y_test = pd.read_csv("../../../_2019/Source Code/week 9/test_y.txt", sep = ',', header = None)
X_train = pd.read_csv("../../../_2019/Source Code/week 8/train_x.txt", sep = ',', header = 0)
X_test = pd.read_csv("../../../_2019/Source Code/week 9/test_x.txt", sep = ',', header = 0)
